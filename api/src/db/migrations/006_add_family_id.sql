...
ALTER TABLE bucks_balance      ADD CONSTRAINT bucks_balance_pkey PRIMARY KEY (family_id, child) NOT VALID;
...
ALTER TABLE screen_time_balance ADD CONSTRAINT screen_time_balance_pkey PRIMARY KEY (family_id, child) NOT VALID;
...
ALTER TABLE timers              ADD CONSTRAINT timers_pkey PRIMARY KEY (family_id, child) NOT VALID;
...
ALTER TABLE meals               ADD CONSTRAINT meals_pkey PRIMARY KEY (family_id, day) NOT VALID;
...
ALTER TABLE routine_log         ADD CONSTRAINT routine_log_pkey PRIMARY KEY (family_id, date, child, routine_id) NOT VALID;
